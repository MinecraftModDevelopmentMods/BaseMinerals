		...
		if (entityLiving instanceof EntityPlayer) {
			...
			if (itemstack != null || flag) {
				...
				if ((double) f >= 0.1D) {
					...
					if (!worldIn.isRemote) {
						final ItemMetalArrow itemMetalBolt = (ItemMetalArrow) (itemstack.getItem() instanceof ItemMetalArrow ? itemstack.getItem() : Items.getItemByName("aluminum_arrow"));
						final EntityCustomArrow entityarrow = itemMetalBolt.createArrow(worldIn, itemstack, entityplayer);
