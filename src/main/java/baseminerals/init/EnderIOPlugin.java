...
public class EnderIOPlugin {
	...
	private static final String ALLOY_SMELTER_MSG =
			"<recipeGroup name=\"" + BaseMinerals.MODID + "\" >" +
			 "<recipe name=\"%s\" energyCost=\"%d\" >" +
			  "<input>" +
			   "<itemStack modID=\"" + BaseMinerals.MODID + "\" itemName=\"%s\" />" +
			  "</input>" +
			  "<output>" +
			   "<itemStack modID=\"" + BaseMinerals.MODID + "\" itemName=\"%s\" />" +
			  "</output>" +
	...
	private static final String SAG_MILL_MSG =
			"<recipeGroup name=\"" + BaseMinerals.MODID + "\">" +
			 "<recipe name=\"%s\" energyCost=\"%d\">" +
			  "<input>" +
			   "<itemStack modID=\"" + BaseMinerals.MODID + "\" itemName=\"%s\" itemMeta=\"%d\" />" +
			  "</input>" +
			  "<output>" +
			   "<itemStack modID=\"" + BaseMinerals.MODID + "\" itemName=\"%s\" itemMeta=\"%d\" number=\"2\" />" +
