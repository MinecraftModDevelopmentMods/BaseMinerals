...
public class VillagerTrades extends cyano.basemetals.init.VillagerTrades {
	...
	public static void init() {
		...
		final int size = baseminerals.init.Materials.getAllMetals().size();
		...
		baseminerals.init.Items.getItemsByMetal().entrySet().stream()
		...
		for(final MetalMaterial m : baseminerals.init.Materials.getAllMetals()) {
