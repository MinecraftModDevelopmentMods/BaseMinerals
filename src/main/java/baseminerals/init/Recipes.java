...
public class Recipes extends cyano.basemetals.init.Recipes {
	...
	private static void initMetalRecipes() {
		...
		for(MetalMaterial metal : Materials.getAllMetals()) {
			...
			Item axe = baseminerals.init.Items.getItemByName(baseName+"axe");
			Item blend = baseminerals.init.Items.getItemByName(baseName+"blend");
			Item boots = baseminerals.init.Items.getItemByName(baseName+"boots");
			Item chestplate = baseminerals.init.Items.getItemByName(baseName+"chestplate");
			Item crackhammer = baseminerals.init.Items.getItemByName(baseName+"crackhammer");
			Item door = baseminerals.init.Items.getItemByName(baseName+"door_item");
			Item helmet = baseminerals.init.Items.getItemByName(baseName+"helmet");
			Item hoe = baseminerals.init.Items.getItemByName(baseName+"hoe");
			Item ingot = baseminerals.init.Items.getItemByName(baseName+"ingot");
			Item leggings = baseminerals.init.Items.getItemByName(baseName+"leggings");
			Item nugget = baseminerals.init.Items.getItemByName(baseName+"nugget");
			Item pickaxe = baseminerals.init.Items.getItemByName(baseName+"pickaxe");
			Item powder = baseminerals.init.Items.getItemByName(baseName+"powder");
			Item shovel = baseminerals.init.Items.getItemByName(baseName+"shovel");
			Item sword = baseminerals.init.Items.getItemByName(baseName+"sword");
			Item rod = baseminerals.init.Items.getItemByName(baseName+"rod");
			Item gear = baseminerals.init.Items.getItemByName(baseName+"gear");
			Block bars = baseminerals.init.Blocks.getBlockByName(baseName+"bars");
			Block block = baseminerals.init.Blocks.getBlockByName(baseName+"block");
			Block plate = baseminerals.init.Blocks.getBlockByName(baseName+"plate");
			Block ore = baseminerals.init.Blocks.getBlockByName(baseName+"ore");
			Block trapdoor = baseminerals.init.Blocks.getBlockByName(baseName+"trapdoor");
			
			Item arrow = baseminerals.init.Items.getItemByName(baseName+"arrow");
			Item bow = baseminerals.init.Items.getItemByName(baseName+"bow");
			Item bolt = baseminerals.init.Items.getItemByName(baseName+"bolt");
			Item crossbow = baseminerals.init.Items.getItemByName(baseName+"crossbow");
			Item shears = baseminerals.init.Items.getItemByName(baseName+"shears");
			Item smallblend = baseminerals.init.Items.getItemByName(baseName+"smallblend");
			Item smallpowder = baseminerals.init.Items.getItemByName(baseName+"smallpowder");
			Item fishingrod = baseminerals.init.Items.getItemByName(baseName+"fishingrod");
			Item horsearmor = baseminerals.init.Items.getItemByName(baseName+"horsearmor");
...
//			if(rod != null && bolt != null) GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(bolt), "x", "x", "y", 'x', "rod"+oreDictName, 'y', Items.FEATHER));
		...
		// alloy blends
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(baseminerals.init.Items.template_blend, 2), "dustTemplate", "dustTemplate"));
		
		// small alloy blends
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(baseminerals.init.Items.template_smallblend, 2), "smalldustTemplate", "smalldustTemplate"));
	}
}
