...
@MMDPlugin(addonId = BaseMinerals.MODID, pluginId = BMiMekanism.PLUGIN_MODID)
public class BMiMekanism extends com.mcmoddev.lib.integration.plugins.Mekanism implements IIntegration {
	...
	private void regMek(@Nonnull final String name) {
		...
		if ((!ore.isEmpty()) && (!powder.isEmpty()))
			addEnrichmentChamberRecipe(ore, powder);
	}
}
